...
class rex_yform_value_ycom_auth_oauth2_google extends rex_yform_value_abstract
{
    ...
    public function enterObject(): void
    {
        ...
        $this->auth_FormOutput(rex_getUrl('', '', ['rex_ycom_auth_mode' => 'oauth2_google', 'rex_ycom_auth_func' => 'init', 'returnTo' => $returnTo]));
        ...
        if ('' == $settings['redirectUri']) {
            ...
            dump(rex_yrewrite::getFullUrlByArticleId(rex_article::getCurrentId(), '', ['rex_ycom_auth_mode' => 'oauth2_google', 'rex_ycom_auth_func' => 'code'], '&'));
            return;
        }
    ...
    {
        return 'ycom_auth_oauth2_google|label|error_msg|[allowed returnTo domains: DomainA,DomainB]|default Userdata as Json{"ycom_groups": 3, "termsofuse_accepted": 1}|direct_link 0,1';
    }
}
