...
if(!function_exists("rex_com_deep_in_array"))
{
	function rex_com_deep_in_array($value, $array, $case_insensitive = false){
	   foreach($array as $item){
	       if(is_array($item)) $ret = rex_com_deep_in_array($value, $item, $case_insensitive);
...
if (!rex_com_deep_in_array($subpage,$REX['ADDON'][$page]['SUBPAGES'])) 
	$subpage = "";
